  ...
  var handleChange = function handleChange(e, isChangingFromSelection) {
    ...
    if ($anchor.data('highlight') || $focus.data('highlight')) {
      if ($first.attr('data-highlight') === 'next') {
        ...
        var _timestamp = $first.attr('data-start') || $first.attr('data-timestamp') || $focus.attr('data-start') || $focus.attr('data-timestamp');
        $first.parent().attr('data-start') || $first.parent().attr('data-timestamp') || $focus.parent().attr('data-start') || $focus.parent().attr('data-timestamp');
        url = url + '#' + _timestamp;
      }
    }
