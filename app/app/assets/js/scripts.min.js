...
},{"./buildPage":38,"./destroyPage":44,"./eqHeight":45}],30:[function(require,module,exports){
'use strict';
...
},{"./buildContentNode":35,"./icon":47,"./respBg":49,"./respImg":50,"js-cookie":12}],31:[function(require,module,exports){
'use strict';
...
},{"./buildContentNode":35,"./icon":47,"./respImg":50}],32:[function(require,module,exports){
'use strict';
...
},{"./eqHeight":45,"./icon":47,"./respBg":49,"./respImg":50,"./socialLinks":53}],33:[function(require,module,exports){
'use strict';
...
},{"./internalLink":48}],34:[function(require,module,exports){
'use strict';
...
},{"./icon":47,"./internalLink":48}],35:[function(require,module,exports){
'use strict';
...
},{"./icon":47,"./internalLink":48,"./respImg":50}],36:[function(require,module,exports){
'use strict';
...
},{"./buildCollectionsList":33,"./buildConnected":34,"./icon":47,"./scrollIndicator":51,"./socialLinks":53}],37:[function(require,module,exports){
'use strict';
...
},{"./eqHeight":45,"./icon":47,"./internalLink":48}],38:[function(require,module,exports){
'use strict';
...
},{"./buildSuppInner":40,"./getUrlWithNoHash":46,"./icon":47,"./internalLink":48,"./socialLinks":53,"./syncTimestamps":56}],40:[function(require,module,exports){
'use strict';
...
},{"./icon":47,"./internalLink":48,"./respImg":50}],41:[function(require,module,exports){
'use strict';
...
},{"./icon":47,"./respImg":50,"./socialLinks":53}],42:[function(require,module,exports){
'use strict';
...
},{"./buildCollectionsList":33,"./buildConnected":34,"./icon":47,"./respImg":50,"./socialLinks":53}],43:[function(require,module,exports){
'use strict';
...
},{"./internalLink":48,"./thirdparty/featherlight.gallery.min.js":57,"./thirdparty/featherlight.min":58}],51:[function(require,module,exports){
'use strict';
...
},{"./icon":47}],52:[function(require,module,exports){
'use strict';
...
},{"./getUrlWithNoHash":46,"./socialLinks":53}],53:[function(require,module,exports){
'use strict';
...
},{"./icon":47,"clipboard":4,"facebook-share-link":7}],54:[function(require,module,exports){
'use strict';
...
},{"./icon":47,"js-cookie":12}],56:[function(require,module,exports){
'use strict';
...
var syncTimestamps = function syncTimestamps(supp, node, transcript) {
  ...
  var expand = function expand(target) {
    if ($(window).width() > 568) {
      $('[data-action="expand"]').removeClass('expand').find('[data-action="close"] use').attr('xlink:href', '#expand');
...
},{"./icon":47,"./respImg":50}],57:[function(require,module,exports){
"use strict";
