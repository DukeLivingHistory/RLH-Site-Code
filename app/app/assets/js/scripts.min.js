...
var buildArchive = function buildArchive(page, data, endpoint, canBeCondensed) {
  ...
  if (canBeCondensed) {
    ...
    listView.append('<span class="listView-label">change view:</span>').append(btnExplode).append(icon('explode', 'listView')).append(btnCondense).append(icon('condense', 'listView'));
...
},{"./buildContentNode":35,"./cachebust":44,"./icon":48,"./respBg":50,"./respImg":51,"js-cookie":12}],31:[function(require,module,exports){
'use strict';
...
var buildSuppInner = function buildSuppInner(content) {
  ...
  switch (content.type) {
    ...
    case 'internallink':
      ...
      break;
    case 'map_location':
      var map_url = 'https://maps.googleapis.com/maps/api/staticmap?center=' + content.data.coords.lat + ',' + content.data.coords.lng + '&size=600x300&zoom=17&markers=color:red%7C' + content.data.coords.lat + ',' + content.data.coords.lng + '&key=' + MAPS_APP_ID;
      preview = content.data.title;
      cont += '<span class="suppCont-contentTitle">' + content.data.title + '</span>';
...
var syncAblePlayer = function syncAblePlayer() {
...
},{"./icon":48,"js-cookie":12}],57:[function(require,module,exports){
'use strict';
