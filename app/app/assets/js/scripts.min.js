...
var buildTranscript = function buildTranscript(wrapper, id, cb) {
  ...
  $('body').on('keyup', '#video-search', function () {
    ...
    window.SEARCHDEBUFF = setTimeout(function () {
      ...
      $('[data-expand-search="false"]').removeClass('expand').find('[data-action="close"] use').attr('xlink:href', '#expand');
    }, 500);
  });
};
...
var highlightSuppCont = function highlightSuppCont(nodes, highlight) {
  $(nodes).each(function () {
    var text = $(this).attr('data-suppcont');
    var html = $(this).html();
    var target = $(this).closest('.suppCont-single');
