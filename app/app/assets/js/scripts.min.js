...
var buildArchive = function buildArchive(page, data, endpoint, canBeCondensed, mediaTypes) {
  ...
  if (canBeCondensed) {
    ...
    if (mediaTypes) {
      ...
      listView.append('<span class="listView-label">content types:</span>').append(mediaSelect);
    }
  ...
  var handleListChange = function handleListChange() {
    ...
    var dest = endpoint === 'search' ? endpoint + '/' + $('body').attr('data-search') : endpoint;
    var url = '/wp-json/v1/' + dest + '?order=' + order + '&offset=0&count=' + COUNT + '&include=' + media + cachebust(true);
...
var internalLink = function internalLink(content, inner) {
  var type = content.type + (content.type === 'interactive' ? '' : 's');
