...
add_action( 'wp_enqueue_scripts', function(){
  ...
  wp_enqueue_script( 'main-js', get_template_directory_uri().'/assets/dist/js/bundle.js?update=10', null, null, true );
  wp_enqueue_style( 'main-css', get_template_directory_uri().'/assets/dist/css/styles.min.css?update=10', false, null );
