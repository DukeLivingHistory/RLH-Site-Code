...
},{"./buildPage":11,"./destroyPage":20,"./eqHeight":21}],3:[function(require,module,exports){
'use strict';
...
},{"./buildContentNode":8,"./cachebust":18,"./cutoff":19,"./icon":27,"./respBg":29,"./sublink":34,"js-cookie":56,"query-string":61}],4:[function(require,module,exports){
'use strict';
...
},{"./buildContentNode":8,"./cachebust":18,"./cutoff":19,"./icon":27,"./respImg":30,"./sublink":34,"query-string":61}],5:[function(require,module,exports){
'use strict';
...
},{"./icon":27,"./respBg":29,"./respImg":30,"./sharer":32}],6:[function(require,module,exports){
'use strict';
...
},{"./internalLink":28}],7:[function(require,module,exports){
'use strict';

var icon = require('./icon');
var internalLink = require('./internalLink');

var buildConnected = function buildConnected() {
  var related = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
},{"./icon":27,"./internalLink":28}],8:[function(require,module,exports){
'use strict';
...
},{"./icon":27,"./internalLink":28,"./respImg":30,"shortid":63}],9:[function(require,module,exports){
'use strict';
...
var buildInterviewsHeader = function buildInterviewsHeader(page, _ref) {
  var id = _ref.id,
      ...
      transcript_url = _ref.transcript_url,
      description_url = _ref.description_url,
      link = _ref.link;

  var shareLinks = sharer(link, name, introduction.replace(/(<([^>]+)>)/ig, ''), {});
  var indicator = scrollIndicator('.transcript');
...
},{"./buildCollectionsList":6,"./buildConnected":7,"./icon":27,"./scrollIndicator":31,"./sharer":32}],10:[function(require,module,exports){
'use strict';
...
},{"./cachebust":18,"./eqHeight":21,"./icon":27,"./internalLink":28}],11:[function(require,module,exports){
'use strict';
  ...
  if (queriedObject === 'archive') {
    ...
    $.get(_url2, function (data) {
      ...
      if (endpoint === 'timelines') {
        ...
        buildTimeline(page, data.events, data.intro, function (page) {
...
},{"./animatePage":1,"./buildArchive":3,"./buildCollectionFeed":4,"./buildCollectionHeader":5,"./buildInterviewsHeader":9,"./buildOtherInCollection":10,"./buildSupp":12,"./buildTimeline":14,"./buildTimelineHeader":15,"./buildTranscript":16,"./cachebust":18,"./eqHeight":21,"./getNodeFromTimestamp":22,"./highlightSuppCont":24,"./highlightTranscript":25,"./highlighter":26,"./respImg":30,"./stickyHeader":33,"./syncAblePlayer":35,"js-cookie":56}],12:[function(require,module,exports){
'use strict';
...
var buildSupp = function buildSupp(page, endpoint, queriedObject, callback, mainContentExists) {
  $.get('/wp-json/v1/' + endpoint + '/' + queriedObject + '/supp' + cachebust(), function (results) {
    var timestamps = {};
    var unmatched = [];
    ...
    results.forEach(function (_ref) {
      ...
      if (timestamp || timestamp === 0 && mainContentExists) {
        ...
        timestamps[timestamp].push({ type: type, data: data, open: open });
      } else {
        unmatched.push({ type: type, data: data });
      }
    });
    ...
    for (var timestamp in timestamps) {
      inner = inner + ('\n        <ul class="suppCont-inner" data-timestamp="' + timestamp + '">\n          ' + timestamps[timestamp].map(function (node) {
        var _buildSuppInner = buildSuppInner(node),
            preview = _buildSuppInner.preview,
            cont = _buildSuppInner.cont;

        var url = getUrlWithNoHash() + '#sc-' + index;

        var shareLinks = sharer(url, preview, preview, { clipboardText: preview + '\n' + url });
    ...
    var aside = '<aside class="suppCont">' + inner + '</aside>';

    if (mainContentExists) page.append(aside);

    shares.forEach(function (_ref2) {
      var id = _ref2.id,
          options = _ref2.options;
      sharer().attachHandlers(id, options);
    });
...
},{"./buildSuppInner":13,"./cachebust":18,"./getUrlWithNoHash":23,"./icon":27,"./internalLink":28,"./sharer":32,"./syncTimestamps":36}],13:[function(require,module,exports){
'use strict';
...
},{"./icon":27,"./internalLink":28,"./respImg":30}],14:[function(require,module,exports){
'use strict';
...
var buildTimeline = function buildTimeline(page, events, intro, cb) {
  var shares = [];

  var append = '\n    <div class="content-intro">' + intro + '</div>\n    <ul class="timeline">\n      ' + events.map(function (_ref, index) {
    var event_date = _ref.event_date,
        title = _ref.title,
        image = _ref.image,
        content = _ref.content,
        content_link = _ref.content_link,
        content_link_type = _ref.content_link_type,
        content_link_id = _ref.content_link_id,
        content_link_text = _ref.content_link_text;

    var shareLinks = sharer(window.location.href.split('#')[0] + '#' + index, title, content.replace(/(<([^>]+)>)/ig, ''), {});
...
},{"./icon":27,"./respImg":30,"./sharer":32}],15:[function(require,module,exports){
'use strict';
...
var buildTimelineHeader = function buildTimelineHeader(page, _ref) {
  var link = _ref.link,
      name = _ref.name,
      image = _ref.image,
      introduction = _ref.introduction,
...
},{"./buildCollectionsList":6,"./buildConnected":7,"./icon":27,"./respImg":30,"./sharer":32}],16:[function(require,module,exports){
'use strict';
...
},{"./buildTranscriptMarkup":17,"./cachebust":18,"./highlightSuppCont":24,"./highlightTranscript":25,"js-cookie":56}],17:[function(require,module,exports){
'use strict';
  ...
  var html = data.reduce(function (acc, node) {
    ...
    switch (node.type) {
      ...
      case 'transcript_node':
        var contents = node.contents.replace('href', 'target="_blank" data-highlight="parent" href');
...
},{"./respImg":30,"escape-string-regexp":49}],25:[function(require,module,exports){
'use strict';
...
},{"escape-string-regexp":49}],26:[function(require,module,exports){
'use strict';

var getUrlWithNoHash = require('./getUrlWithNoHash');
var sharer = require('./sharer');

var highlighter = function highlighter(target) {
  var makePopup = function makePopup(url, title, text, style, className, isChangingFromSelection) {
    var shareLinks = sharer(url, title, text, {
      clipboardText: text + '\n' + url,
    ...
    var $popup = $('body').find('.socialPopup');
    ...
    $('.socialPopup').on('mousedown touchstart', function (e) {
      window.SOCIAL_POPUP_SHOULD_BE_REMOVED = false;
      setTimeout(function () {
  ...
  var isInverse = function isInverse(selection) {
    var range = selection.getRangeAt(0);
    var rects = range.getClientRects();
    var offsetBottom = rects[rects.length - 1].bottom;
    var windowHeight = $(window).height();
    return offsetBottom > windowHeight;
  };

  var getLeft = function getLeft(selection) {
    var range = selection.getRangeAt(0);
    var rects = range.getClientRects();
    if (rects.length) return (rects[0].left + rects[0].right) / 2;
  };

  var getTop = function getTop(selection) {
    if (window.IS_TOUCH_SCREEN) {
      ...
      var mid = (_rects[0].top + _rects[0].bottom) / 2;

      if (isInverse(selection)) {
        var offsetBottom = _rects[_rects.length - 1].bottom - 30;
  ...
  var handleChange = function handleChange(e, isChangingFromSelection) {
    ...
    var $anchor = $(anchorNode.parentNode);
    var $focus = $(focusNode.parentNode);
    var $first = $anchor.index() < $focus.index() ? $anchor : $focus;

    if (!$focus.parents(target).length) {
      return;
    }
    ...
    if ($anchor.data('highlight') || $focus.data('highlight')) {
      if ($first.attr('data-highlight') === 'next') {
        ...
        var _$next = $focus.next();
        var _timestamp = _$next.attr('data-start') || _$next.attr('data-timestamp');
        url = url + '#' + _timestamp;
        window.TEMPURL = url;
      } else if ($first.attr('data-highlight') === 'parent') {
        var _$next2 = $first.parent();
        var _timestamp2 = _$next2.attr('data-start') || _$next2.attr('data-timestamp');
        url = url + '#' + _timestamp2;
        window.TEMPURL = url;
      } else if ($focus.attr('data-highlight') === 'parent') {
        var _$next3 = $focus.parent();
        var _timestamp3 = _$next3.attr('data-start') || _$next3.attr('data-timestamp');
        url = url + '#' + _timestamp3;
        window.TEMPURL = url;
      } else if ($first.attr('data-highlight') === 'transcript' || $focus.attr('data-highlight') === 'transcript') {
        var _timestamp4 = $first.attr('data-start') || $first.attr('data-timestamp') || $focus.attr('data-start') || $focus.attr('data-timestamp');
        url = url + '#' + _timestamp4;
        window.TEMPURL = url;
      } else {
        url = window.TEMPURL;
    ...
    window.POPUP = setTimeout(function () {
...
},{"./getUrlWithNoHash":23,"./sharer":32}],27:[function(require,module,exports){
'use strict';
...
var respBg = function respBg(elem) {
  ...
  var url = '/wp-json/v1/images/' + id + '/' + set + '_' + getSize() + cachebust();
  console.log(url);
...
},{"./cachebust":18}],30:[function(require,module,exports){
'use strict';
...
},{"./cachebust":18,"./internalLink":28,"./thirdparty/featherlight.gallery.min.js":37,"./thirdparty/featherlight.min":38}],31:[function(require,module,exports){
'use strict';

var icon = require('./icon');

var scrollIndicator = function scrollIndicator(ref) {
  var render = '<div class="scrollIndicator">' + icon('down', 'scrollIndicator') + '</div>';
  ...
  var _attachHandlers = function _attachHandlers() {
    toggle(ref);
    $(window).on('scroll resize', function () {
      toggle(ref);
    });
    $('body').unbind('click.scrollIndicator').on('click.scrollIndicator', '.scrollIndicator', function () {
      var scrollTop = $(ref).offset().top - 33;
...
},{"./icon":27}],32:[function(require,module,exports){
'use strict';
...
var sharer = function sharer() {
  ...
  var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
      clipboardText = _ref.clipboardText,
  ...
  var attachClipboardHandlers = function attachClipboardHandlers(clipboard) {
  ...
  var _attachHandlers = function _attachHandlers(specificId, specificOptions) {
    var _id = specificId || id;
    var _options = specificOptions || options;

    var clipboard = new Clipboard('[data-share-id="' + _id + '"] [data-soc="link"]');
    ...
    $('body').on('click', '[data-share-id="' + _id + '"] li', function (e) {
      ...
      switch (type) {
        case "fb":
          ...
          return;
        case "tw":
          var _url = encodeURIComponent(_options.url);
          var _quote = encodeURIComponent(_options.quote);
          link = 'http://twitter.com/intent/tweet?url=' + _url + '&text=' + _quote;
  ...
  return {
    render: render,
    attachHandlers: function attachHandlers(id, options) {
      _attachHandlers(id, options);
    },
    id: id,
    options: options
  };
...
},{"./icon":27,"clipboard":45,"facebook-share-link":50,"shortid":63}],33:[function(require,module,exports){
'use strict';
...
},{"./cachebust":18,"./getNodeFromTimestamp":22,"./icon":27,"js-cookie":56}],36:[function(require,module,exports){
'use strict';
...
},{"./icon":27,"./respImg":30}],37:[function(require,module,exports){
"use strict";
...
},{"./eqHeight":39,"./img":40}],42:[function(require,module,exports){
...
},{"select":62}],45:[function(require,module,exports){
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
...
},{"./clipboard-action":44,"good-listener":53,"tiny-emitter":75}],46:[function(require,module,exports){
'use strict';
var token = '%[a-f0-9]{2}';
...
},{"./closest":47}],49:[function(require,module,exports){
'use strict';
...
},{"ap":42,"assert-ok":43,"parse-int":60,"query-string":51,"snakecase-keys":73,"url-set-query":79,"value-pipe":80,"xtend":81}],51:[function(require,module,exports){
'use strict';
...
},{"strict-uri-encode":74}],52:[function(require,module,exports){
/**
...
},{"./is":52,"delegate":48}],54:[function(require,module,exports){
'use strict';
...
},{"number-is-nan":58}],55:[function(require,module,exports){
...
},{"is-finite":54}],56:[function(require,module,exports){
/*!
...
},{"is-integer":55}],61:[function(require,module,exports){
'use strict';
var strictUriEncode = require('strict-uri-encode');
...
},{"decode-uri-component":46,"object-assign":59,"strict-uri-encode":74}],62:[function(require,module,exports){
...
},{"./lib/index":68}],64:[function(require,module,exports){
'use strict';
...
},{"./random/random-from-seed":71}],65:[function(require,module,exports){
'use strict';
...
},{"./alphabet":64,"./encode":67}],66:[function(require,module,exports){
'use strict';
var alphabet = require('./alphabet');
...
},{"./alphabet":64}],67:[function(require,module,exports){
'use strict';
...
},{"./random/random-byte":70}],68:[function(require,module,exports){
'use strict';
...
},{"./alphabet":64,"./build":65,"./decode":66,"./encode":67,"./is-valid":69,"./util/cluster-worker-id":72}],69:[function(require,module,exports){
'use strict';
var alphabet = require('./alphabet');
...
},{"./alphabet":64}],70:[function(require,module,exports){
'use strict';
...
},{"map-obj":57,"to-snake-case":77}],74:[function(require,module,exports){
'use strict';
module.exports = function (str) {
...
},{"to-space-case":78}],78:[function(require,module,exports){
...
},{"to-no-case":76}],79:[function(require,module,exports){
