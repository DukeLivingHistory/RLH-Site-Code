...
(function ($) {
  ...
  window.AblePlayer = function(media) {
    ...
    if ($(media).data('youtube-playsinline') !== undefined) {
      this.youTubePlaysInline = 1;
    }
  ...
  AblePlayer.prototype.finalizeYoutubeInit = function () {
    ...
    this.youTubePlayer = new YT.Player(containerId, {
      ...
      playerVars: {
        ...
        playsinline: this.youTubePlaysInline // enable inline playback for iOS
      },
      events: {
        onReady: function () {
...
"nextChapter": "NÃ¤chste Kapitel",

"prevTrack": "Vorheriges track",

"nextTrack": "NÃ¤chste Titel",

"rewind": "ZurÃ¼ck springen",

"forward": "VorwÃ¤rts springen",
...
"sign": "GebÃ¤rdensprache",

"showSign": "GebÃ¤rdensprache anzeigen",

"hideSign": "GebÃ¤rdensprache verstecken",
...
"volumeHelp": "Eingabetaste drÃ¼cken, um den LautstÃ¤rkeregler zu bedienen",

"volumeUpDown": "LautstÃ¤rkeregler",

"volumeSliderClosed": "LautstÃ¤rkeregler verlassen",
...
"statusLoadingNext": "Der nÃ¤chste Titel wird geladen",

"statusEnd": "Ende des Titels",

"selectedTrack": "AusgewÃ¤hlter Titel",
...
"fallbackError1": "Abspielen ist mit diesem Browser nicht mÃ¶glich",

"fallbackError2": "Folgende Browser wurden mit AblePlayer getestet",

"orHigher": "oder hÃ¶her",
...
"prefIntroDescription1": "Dieser Media Player unterstÃ¼tzt zwei Arten von Untertiteln: ",
...
"prefIntroDescription4": "Wenn die Audiodeskription aktiviert ist, kann sie per SchaltflÃ¤che ein- und ausgeschaltet werden.",

"prefIntroKeyboard1": "Dieser Media Player lÃ¤sst sich innerhalb der gesamten Seite per TastenkÃ¼rzel bedienen (siehe unten).",

"prefIntroKeyboard2": "Die Modifikatortasten (Umschalt, Alt, und Strg) kÃ¶nnen hier zugeordnet werden.",

"prefIntroKeyboard3": "Beachte: Einige Tastenkombinationen sind je nach Browser und Betriebssystem nicht mÃ¶glich. Versuchen Sie gegebenenfalls andere Kombinationen.",

"prefIntroTranscript": "Diese Einstellungen beeinflussen die interaktiven Transkriptionen.",

"prefCookieWarning": "Cookies werden benÃ¶tigt, um Ihre Einstellungen abzuspeichern.",

"prefHeadingKeyboard1": "Modifikatortasten fÃ¼r die TastenkÃ¼rzel",

"prefHeadingKeyboard2": "Aktuell eingestellte TastenkÃ¼rzel",
...
"escapeKeyFunction": "Dialogfenster schlieÃŸen",

"prefDescFormat": "Bevorzugtes Format",

"prefDescFormatHelp": "Wenn beide Formate vorhanden sind, wird nur eines verwendet.",

"prefDescFormatOption1": "Version des Videos, die eine Audiodeskription enthÃ¤lt",
...
"prefHighlight": "Transkription hervorheben, wÃ¤hrend das Medium abgespielt wird",
...
"captionsPositionOverlay": "Ãœberlagert",

"captionsPositionBelow": "Unterhalb",

"sampleCaptionText": "Textbeispiel",

"prefSuccess": "Ihre Ã„nderungen wurden gespeichert.",

"prefNoChange": "Es gab keine Ã„nderungen zu speichern.",
...
"windowResize": "GrÃ¶ÃŸe verÃ¤ndern",

"windowResizeHeading": "GrÃ¶ÃŸe des GebÃ¤rdensprache-Fenster",

"windowResizeAlert": "Die GrÃ¶ÃŸe wurde angepasst.",
...
"prevChapter": "CapÃ­tulo Anterior",
...
"showCaptions": "Mostrar subtÃ­tulos",

"hideCaptions": "Ocultar subtÃ­tulos",

"captionsOff": "Sin subtÃ­tulos",

"showTranscript": "Mostrar transcripciÃ³n",

"hideTranscript": "Ocultar transcripciÃ³n",
...
"newChapter": "Nuevo capÃ­tulo",

"language": "Idioma",

"sign": "Lengua de seÃ±as",

"showSign": "Mostrar lengua de seÃ±as",

"hideSign": "Ocultar lengua de seÃ±as",
...
"statusUsingDesc": "Utilizando versiÃ³n descrita",

"statusLoadingDesc": "Cargando versiÃ³n descrita",

"statusUsingNoDesc": "Utilizando versiÃ³n no descrita",

"statusLoadingNoDesc": "Cargando versiÃ³n no descrita",
...
"alertDescribedVersion": "Utilizando la versiÃ³n audiodescrita del vÃ­deo",

"alertNonDescribedVersion": "Utilizando la versiÃ³n no descrita de este vÃ­deo",
...
"prefMenuCaptions": "SubtÃ­tulos",

"prefMenuDescriptions": "Descripciones",

"prefMenuKeyboard": "Teclado",

"prefMenuTranscript": "TranscripciÃ³n",

"prefTitleCaptions": "Preferencias de subtÃ­tulos",

"prefTitleDescriptions": "Preferencias de audiodescripciÃ³n",

"prefTitleKeyboard": "Preferencias de teclado",

"prefTitleTranscript": "Preferencias de transcripciÃ³n",

"prefIntroCaptions": "Las siguientes preferencias controlan cÃ³mo se presentan los subtÃ­tulos.",

"prefIntroDescription1": "Este reproductor soporta la audiodescripciÃ³n de dos maneras: ",

"prefIntroDescription2": "El vÃ­deo actual tiene ",

"prefIntroDescriptionNone": "El vÃ­deo actual no tiene audiodescripciÃ³n de ninguna manera.",

"prefIntroDescription3": "Utilice el siguiente formulario para establecer sus preferencias en cuanto a la audiodescripciÃ³n.",

"prefIntroDescription4": "Una vez guardadas sus preferencias, la audiodescripciÃ³n puede habilitarse o deshabilitarse mediante el botÃ³n DescripciÃ³n.",

"prefIntroKeyboard1": "El reproductor en esta pÃ¡gina puede manejarse desde cualquier parte de la pÃ¡gina utilizando los atajos de teclado (vea la lista mÃ¡s abajo).",
...
"prefIntroTranscript": "Las siguientes preferencias afectan a la transcripciÃ³n interactiva.",
...
"prefHeadingCaptions": "SubtÃ­tulos",

"prefHeadingTranscript": "TranscripciÃ³n interactiva",

"prefAltKey": "Alt",

"prefCtrlKey": "Control",

"prefShiftKey": "MayÃºsculas",

"escapeKey": "Escape",

"escapeKeyFunction": "Cerrar el cuadro de diÃ¡logo o menÃº contextual",

"prefDescFormat": "Formato preferido",

"prefDescFormatHelp": "Si ambos formatos estÃ¡n disponibles, se usarÃ¡ sÃ³lo uno de ello.",

"prefDescFormatOption1": "versiÃ³n alternativa del vÃ­deo, descrito",

"prefDescFormatOption1b": "una versiÃ³n alternativa con descripciÃ³n",

"prefDescFormatOption2": "descripciÃ³n en texto, leÃ­da por el lector de pantalla",

"prefDescFormatOption2b": "descripciÃ³n en texto",

"prefDescPause": "Pausar automÃ¡ticamente el video cuando arranque una descripciÃ³n",

"prefVisibleDesc": "Hacer visibles las descripciones en texto si se estÃ¡n usando",

"prefHighlight": "Resaltar la transcripciÃ³n segÃºn avanza el contenido",

"prefTabbable": "TranscripciÃ³n manejable por teclado",
...
"prefCaptionsSize": "TamaÃ±o de Fuente",
...
"prefCaptionsPosition": "PosiciÃ³n",

"captionsPositionOverlay": "Cubrir",

"captionsPositionBelow": "Debajo del vÃ­deo",

"sampleCaptionText": "Texto de ejemplo de subtÃ­tulo",

"prefSuccess": "Los cambios han sido guardados.",

"prefNoChange": "No se ha hecho ningÃºn cambio.",
...
"closeButtonLabel": "Cerrar cuadro de diÃ¡logo",
...
"windowResizeHeading": "Redimensionar la ventana con el intÃ©rprete",
...
"windowSendBack": "Enviar atrÃ¡s",

"windowSendBackAlert": "Esta ventana no se encuentra tras otros objetos en la pÃ¡gina.",

"windowBringTop": "Traer al frente",

"windowBringTopAlert": "Esta ventan estÃ¡ ahora en el frente de otros objetos en la pÃ¡gina."

};

var fr = {

"playerHeading": "Lecteur multimÃ©dia",
...
"prevChapter": "Chapitre PrÃ©cÃ©dente",

"nextChapter": "Chapitre Suivante",

"prevTrack": "Piste PrÃ©cÃ©dente",
...
"captionsOff": "Sous-titres dÃ©sactivÃ©s",
...
"turnOffDescriptions": "DÃ©sactiver les descriptions",
...
"volumeHelp": "Cliquer pour accÃ©der au rÃ©glage du volume",

"volumeUpDown": "Monter baisser le volume",

"volumeSliderClosed": "RÃ©glage du volume fermÃ©",

"preferences": "PrÃ©fÃ©rences",

"enterFullScreen": "Activer le mode plein Ã©cran",

"exitFullScreen": "Quitter le mode plein Ã©cran",
...
"statusUsingDesc": "Utilisation de la version dÃ©crite",

"statusLoadingDesc": "Chargement de la version dÃ©crite",

"statusUsingNoDesc": "Utilisation de la version non dÃ©crite",

"statusLoadingNoDesc": "Chargement de la version non dÃ©crite",
...
"alertDescribedVersion": "Utilisation de la version avec description sonore de cette vidÃ©o",

"alertNonDescribedVersion": "Utilisation de la version non dÃ©crite de cette vidÃ©o",

"fallbackError1": "DÃ©solÃ©, votre navigateur ne peut pas lire cette piste",

"fallbackError2": "Les navigateurs suivants fonctionnent habituellement avec ce lecteur multimÃ©dia",

"orHigher": "ou des versions plus rÃ©centes",
...
"prefTitleCaptions": "PrÃ©fÃ©rences liÃ©es au sous-titrage",

"prefTitleDescriptions": "PrÃ©fÃ©rences liÃ©es aux descriptions sonores",

"prefTitleKeyboard": "PrÃ©fÃ©rences liÃ©es au clavier",

"prefTitleTranscript": "PrÃ©fÃ©rence liÃ©es Ã  la transcription",

"prefIntroCaptions": "Les prÃ©fÃ©rences contrÃ´lent la faÃ§on dont les sous-titres sont affichÃ©s.",

"prefIntroDescription1": "Ce lecteur multimÃ©dia permet dâ€™entendre les descriptions sonores de deux faÃ§ons:",

"prefIntroDescription2": "Il y a une version ",

"prefIntroDescriptionNone": "Il nâ€™y a pas de version avec description sonore (dans ni lâ€™un ni lâ€™autre des formats) de la prÃ©sente vidÃ©o.",

"prefIntroDescription3": "Utilisez le formulaire suivant pour Ã©tablir vos prÃ©fÃ©rences liÃ©es aux descriptions sonores.",

"prefIntroDescription4": "AprÃ¨s avoir enregistrÃ© vos prÃ©fÃ©rences, vous pouvez activer ou dÃ©sactiver la description sonore avec le bouton Description.",

"prefIntroKeyboard1": "Le lecteur multimÃ©dia de cette page Web peut Ãªtre utilisÃ© Ã  partir de nâ€™importe quel endroit sur la page avec des raccourcis du clavier (voir la liste ci-dessous).",

"prefIntroKeyboard2": "Des rÃ´les peuvent Ãªtre assignÃ©s aux touches de modification (Shift, Alt, Ctrl) ci-dessous.",

"prefIntroKeyboard3": "Certaines combinaisons de touches pourraient entrer en conflit avec les touches utilisÃ©es par votre navigateur ou autres applications logicielles. Essayez diverses combinaisons de touches de modification pour en trouver qui fonctionnent pour vous.",

"prefIntroTranscript": "Les prÃ©fÃ©rences suivantes ont un effet sur la transcription interactive.",

"prefCookieWarning": "Il faut que les tÃ©moins soient activÃ©s pour enregistrer vos prÃ©fÃ©rences.",

"prefHeadingKeyboard1": "Touches de modification utilisÃ©es pour des raccourcis",

"prefHeadingKeyboard2": "Raccourcis du clavier assignÃ©s actuellement",
...
"escapeKeyFunction": "Fermer la fenÃªtre de dialogue ou le menu contextuel",

"prefDescFormat": "Format privilÃ©giÃ©",

"prefDescFormatHelp": "Si les deux formats sont offerts, un seul sera utilisÃ©.",

"prefDescFormatOption1": "autre version de la vidÃ©o avec description",

"prefDescFormatOption1b": "autre version avec description",

"prefDescFormatOption2": "description textuelle, lue Ã  lâ€™aide dâ€™un lecteur dâ€™Ã©cran",

"prefDescFormatOption2b": "description textuelle",

"prefDescPause": "Mettre la vidÃ©o en pause automatiquement quand la description commence",

"prefVisibleDesc": "Affichez la description",

"prefHighlight": "Surligner la transcription pendant la lecture",

"prefTabbable": "Transcription activÃ©e par clavier",

"prefCaptionsFont": "Police de caractÃ¨res",

"prefCaptionsColor": "Couleur du texte",

"prefCaptionsBGColor": "ArriÃ¨re-plan",

"prefCaptionsSize": "Taille de la police",

"prefCaptionsOpacity": "OpacitÃ©",
...
"cursive": "Ã©criture cursive",

"fantasy": "Ã©criture de fantaisie",

"monospace": "Ã  taille fixe",
...
"captionsPositionOverlay": "SuperposÃ©s",

"captionsPositionBelow": "Sous la vidÃ©o",

"sampleCaptionText": "Ã‰chantillon de sous-titre",

"prefSuccess": "Vos changements ont Ã©tÃ© enregistrÃ©s.",

"prefNoChange": "Vous nâ€™avez pas fait de changements.",
...
"windowButtonLabel": "Options de fenÃªtre",

"windowMove": "DÃ©placer",

"windowMoveAlert": "Faites glisser avec la souris ou utilisez les touches flÃ©chÃ©es pour dÃ©placer la fenÃªtre; appuyez sur Â« Enter Â» pour arrÃªter.",

"windowResize": "Redimensionner",

"windowResizeHeading": "Redimensionner la fenÃªtre de lâ€™interprÃ¨te",

"windowResizeAlert": "La fenÃªtre a Ã©tÃ© redimensionnÃ©e.",

"width": "Largeur",

"height": "Hauteur",

"windowSendBack": "Mettre en arriÃ¨re-plan",

"windowSendBackAlert": "Cette fenÃªtre est maintenant derriÃ¨re dâ€™autres objets sur la page.",

"windowBringTop": "Mettre au premier plan",

"windowBringTopAlert": "Cette fenÃªtre est maintenant devant dâ€™autres objets sur la page.",

};

var ja = {

"playerHeading": "ãƒ¡ãƒ‡ã‚£ã‚¢ãƒ—ãƒ¬ã‚¤ãƒ¤ãƒ¼",
...
"prevChapter": "å‰ã®ãƒãƒ£ãƒ—ã‚¿ãƒ¼",

"nextChapter": "æ¬¡ã®ãƒãƒ£ãƒ—ã‚¿ãƒ¼",

"prevTrack": "å‰ã®ãƒˆãƒ©ãƒƒã‚¯",

"nextTrack": "æ¬¡ã®ãƒˆãƒ©ãƒƒã‚¯",

"rewind": "å·»ãæˆ»ã—",

"forward": "æ—©é€ã‚Š",

"captions": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³",

"showCaptions": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³ã‚’è¡¨ç¤ºã™ã‚‹",

"hideCaptions": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³ã‚’éžè¡¨ç¤ºã«ã™ã‚‹",

"captionsOff": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³ã‚’æ¶ˆã™",

"showTranscript": "æ›¸ãèµ·ã“ã—ã®è¡¨ç¤º",

"hideTranscript": "æ›¸ãèµ·ã“ã—ã‚’éžè¡¨ç¤ºã«ã™ã‚‹",

"turnOnDescriptions": "éŸ³å£°è§£èª¬ã‚’å‡ºã™",

"turnOffDescriptions": "éŸ³å£°è§£èª¬ã‚’å‡ºã•ãªã„",

"chapters": "ãƒãƒ£ãƒ—ã‚¿ãƒ¼",

"newChapter": "æ–°ã—ã„ãƒãƒ£ãƒ—ã‚¿ãƒ¼",

"language": "è¨€èªž",

"sign": "æ‰‹è©±",

"showSign": "æ‰‹è©±ã‚’è¡¨ç¤º",

"hideSign": "æ‰‹è©±ã‚’éžè¡¨ç¤º",
...
"volumeHelp": "ã‚¯ãƒªãƒƒã‚¯ã—ã¦éŸ³é‡ã‚¹ãƒ©ã‚¤ãƒ€ãƒ¼ã‚’æ“ä½œã—ã¾ã™",

"volumeUpDown": "éŸ³é‡ã®ä¸Šä¸‹",

"volumeSliderClosed": "éŸ³é‡ã‚¹ãƒ©ã‚¤ãƒ€ãƒ¼çµ‚äº†",
...
"spacebar": "ã‚¹ãƒšãƒ¼ã‚¹ã‚­ãƒ¼",

"transcriptTitle": "æ›¸ãèµ·ã“ã—",
...
"statusWaiting": "å¾…æ©Ÿä¸­",

"statusBuffering": "ãƒãƒƒãƒ•ã‚¡ãƒªãƒ³ã‚°ä¸­",

"statusUsingDesc": "è§£èª¬ä»˜ãå‹•ç”»ã‚’ä½¿ã„ã¾ã™",

"statusLoadingDesc": "è§£èª¬ä»˜ãå‹•ç”»ã‚’èª­ã¿è¾¼ã¿ä¸­",

"statusUsingNoDesc": "è§£èª¬ãªã—ã®ãƒãƒ¼ã‚¸ãƒ§ãƒ³ã‚’ä½¿ã„ã¾ã™",

"statusLoadingNoDesc": "è§£èª¬ãªã—ã®ãƒãƒ¼ã‚¸ãƒ§ãƒ³ã‚’èª­ã¿è¾¼ã‚“ã§ã„ã¾ã™",

"statusLoadingNext": "æ¬¡ã®ãƒˆãƒ©ãƒƒã‚¯ã‚’èª­ã¿è¾¼ã‚“ã§ã„ã¾ã™",

"statusEnd": "ãƒˆãƒ©ãƒƒã‚¯ã®çµ‚ã‚ã‚Š",

"selectedTrack": "é¸æŠžã•ã‚ŒãŸãƒˆãƒ©ãƒƒã‚¯",

"alertDescribedVersion": "ã“ã®å‹•ç”»ã®éŸ³å£°è§£èª¬ä»˜ããƒãƒ¼ã‚¸ãƒ§ãƒ³ã‚’ä½¿ã„ã¾ã™",

"alertNonDescribedVersion": "ã“ã®å‹•ç”»ã®è§£èª¬ãªã—ãƒãƒ¼ã‚¸ãƒ§ãƒ³ã‚’ä½¿ã„ã¾ã™",

"fallbackError1": "ç”³ã—è¨³ã”ã–ã„ã¾ã›ã‚“ã€‚ã‚ãªãŸã®ãƒ–ãƒ©ã‚¦ã‚¶ã¯ã“ã‚Œã‚’å†ç”Ÿã§ãã¾ã›ã‚“",

"fallbackError2": "ä»¥ä¸‹ã®ãƒ–ãƒ©ã‚¦ã‚¶ã§ã¯ã“ã®ãƒ—ãƒ¬ã‚¤ãƒ¤ãƒ¼ãŒåˆ©ç”¨å¯èƒ½ã§ã‚ã‚‹ã“ã¨ãŒçŸ¥ã‚‰ã‚Œã¦ã„ã¾ã™",

"orHigher": "ä»¥é™",

"prefMenuCaptions": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³",

"prefMenuDescriptions": "éŸ³å£°è§£èª¬",

"prefMenuKeyboard": "ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰",

"prefMenuTranscript": "å­—å¹•",

"prefTitleCaptions": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³ã®è¨­å®š",

"prefTitleDescriptions": "éŸ³å£°è§£èª¬ã®è¨­å®š",

"prefTitleKeyboard": "ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ã®è¨­å®š",

"prefTitleTranscript": "å­—å¹•ã®è¨­å®š",

"prefIntroCaptions": "ä»¥ä¸‹ã®è¨­å®šã¯ã€ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³ãŒã©ã†è¡¨ç¤ºã•ã‚Œã‚‹ã‹ã‚’ã‚³ãƒ³ãƒˆãƒ­ãƒ¼ãƒ«ã—ã¾ã™ã€‚",

"prefIntroDescription1": "ã“ã®ãƒ¡ãƒ‡ã‚£ã‚¢ãƒ—ãƒ¬ã‚¤ãƒ¤ãƒ¼ã¯æ¬¡ã®2ã¤ã®æ–¹æ³•ã§éŸ³å£°è§£èª¬ã‚’ã‚µãƒãƒ¼ãƒˆã—ã¾ã™: ",

"prefIntroDescription2": "ç¾åœ¨ã®å‹•ç”»ã§ã¯æ¬¡ã®æ–¹æ³•ãŒé¸æŠžå¯èƒ½ã§ã™: ",

"prefIntroDescriptionNone": "ç¾åœ¨ã®å‹•ç”»ã«ã¯ã©ã¡ã‚‰ã®å½¢å¼ã®éŸ³å£°è§£èª¬ã‚‚å«ã¾ã‚Œã¦ã„ã¾ã›ã‚“ã€‚",

"prefIntroDescription3": "æ¬¡ã®ãƒ•ã‚©ãƒ¼ãƒ ã‚’ä½¿ã£ã¦ã€éŸ³å£°è§£èª¬ã«é–¢é€£ã™ã‚‹è¨­å®šã‚’ä¿å­˜ã§ãã¾ã™ã€‚",

"prefIntroDescription4": "è¨­å®šãŒä¿å­˜ã•ã‚ŒãŸã‚‰ã€éŸ³å£°è§£èª¬ãƒœã‚¿ãƒ³ã«ã‚ˆã£ã¦éŸ³å£°è§£èª¬ã®è¡¨ç¤ºãƒ»éžè¡¨ç¤ºã‚’åˆ‡ã‚Šæ›¿ãˆã‚‹ã“ã¨ãŒã§ãã¾ã™ã€‚",

"prefIntroKeyboard1": "ã“ã®ãƒšãƒ¼ã‚¸ã®ãƒ¡ãƒ‡ã‚£ã‚¢ãƒ—ãƒ¬ã‚¤ãƒ¤ãƒ¼ã¯ã€ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ãƒ»ã‚·ãƒ§ãƒ¼ãƒˆã‚«ãƒƒãƒˆã‚’ä½¿ã£ã¦ã“ã®ãƒšãƒ¼ã‚¸ã®ã©ã“ã‹ã‚‰ã§ã‚‚æ“ä½œã§ãã¾ã™(ä¸‹ã®ä¸€è¦§ã‚’å‚ç…§ã—ã¦ãã ã•ã„)ã€‚",

"prefIntroKeyboard2": "ä¿®é£¾ã‚­ãƒ¼(Shiftã€Alt ã¨ Control) ã¯ä»¥ä¸‹ã§å‰²ã‚Šå½“ã¦ã‚‹ã“ã¨ãŒã§ãã¾ã™ã€‚",

"prefIntroKeyboard3": "æ³¨æ„: ã„ãã¤ã‹ã®ã‚­ãƒ¼ã®çµ„ã¿åˆã‚ã›ã¯ã€ãƒ–ãƒ©ã‚¦ã‚¶ã‚„ã‚¢ãƒ—ãƒªã‚±ãƒ¼ã‚·ãƒ§ãƒ³ãƒ»ã‚½ãƒ•ãƒˆã§ä½¿ã‚ã‚Œã¦ã„ã‚‹ã‚‚ã®ã¨è¡çªã™ã‚‹å¯èƒ½æ€§ãŒã‚ã‚Šã¾ã™ã€‚ã”åˆ©ç”¨ã®ç’°å¢ƒã§æ­£ã—ãå‹•ä½œã™ã‚‹ã€æ§˜ã€…ãªã‚­ãƒ¼ã®çµ„ã¿åˆã‚ã›ã‚’è©¦ã—ã¦ãã ã•ã„ã€‚",

"prefIntroTranscript": "ä»¥ä¸‹ã®è¨­å®šã¯ã‚¤ãƒ³ã‚¿ãƒ©ã‚¯ãƒ†ã‚£ãƒ–ãªå­—å¹•ã«ä½œç”¨ã—ã¾ã™ã€‚",

"prefCookieWarning": "è¨­å®šã‚’å¤‰æ›´ã™ã‚‹ã«ã¯CookieãŒå¿…è¦ã§ã™ã€‚",

"prefHeadingKeyboard1": "ã‚·ãƒ§ãƒ¼ãƒˆã‚«ãƒƒãƒˆã®ä¿®é£¾ã‚­ãƒ¼",

"prefHeadingKeyboard2": "ç¾åœ¨ã®ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ãƒ»ã‚·ãƒ§ãƒ¼ãƒˆã‚«ãƒƒãƒˆ",

"prefHeadingDescription": "éŸ³å£°è§£èª¬",

"prefHeadingTextDescription": "ãƒ†ã‚­ã‚¹ãƒˆã«ã‚ˆã‚‹éŸ³å£°è§£èª¬",

"prefHeadingCaptions": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³",

"prefHeadingTranscript": "ã‚¤ãƒ³ã‚¿ãƒ©ã‚¯ãƒ†ã‚£ãƒ–ãªå­—å¹•",
...
"escapeKeyFunction": "ç¾åœ¨ã®ãƒ€ã‚¤ã‚¢ãƒ­ã‚°ã‚„ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—ãƒ¡ãƒ‹ãƒ¥ãƒ¼ã‚’é–‰ã˜ã‚‹",

"prefDescFormat": "ãƒ•ã‚©ãƒ¼ãƒžãƒƒãƒˆã®é¸æŠž",

"prefDescFormatHelp": "ä¸¡æ–¹ã®ãƒ•ã‚©ãƒ¼ãƒžãƒƒãƒˆãŒåˆ©ç”¨å¯èƒ½ãªå ´åˆã€ã©ã¡ã‚‰ã‹ã®ã¿åˆ©ç”¨ã•ã‚Œã¾ã™ã€‚",

"prefDescFormatOption1": "è§£èª¬ä»˜ãã®ä»£æ›¿ãƒãƒ¼ã‚¸ãƒ§ãƒ³ã®ãƒ“ãƒ‡ã‚ª",

"prefDescFormatOption1b": "è§£èª¬ä»˜ãã®ä»£æ›¿ãƒãƒ¼ã‚¸ãƒ§ãƒ³",

"prefDescFormatOption2": "ãƒ†ã‚­ã‚¹ãƒˆã«ã‚ˆã‚‹è§£èª¬(ã‚¹ã‚¯ãƒªãƒ¼ãƒ³ãƒªãƒ¼ãƒ€ãƒ¼ã«ã‚ˆã£ã¦èª­ã¿ä¸Šã’ã‚‰ã‚Œã‚‹)",

"prefDescFormatOption2b": "ãƒ†ã‚­ã‚¹ãƒˆã«ã‚ˆã‚‹è§£èª¬",

"prefDescPause": "è§£èª¬ãŒè¡¨ç¤ºã•ã‚ŒãŸã‚‰å‹•ç”»ã‚’è‡ªå‹•çš„ã«åœæ­¢ã™ã‚‹",

"prefVisibleDesc": "è§£èª¬ãŒè¦‹ãˆã‚‹ã‚ˆã†ã«ã™ã‚‹",

"prefHighlight": "ãƒ¡ãƒ‡ã‚£ã‚¢ã®å†ç”Ÿã«åˆã‚ã›ã¦å­—å¹•ã‚’ãƒã‚¤ãƒ©ã‚¤ãƒˆã™ã‚‹",

"prefTabbable": "ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰æ“ä½œå¯èƒ½ãªå­—å¹•",

"prefCaptionsFont": "ãƒ•ã‚©ãƒ³ãƒˆ",

"prefCaptionsColor": "æ–‡å­—è‰²",

"prefCaptionsBGColor": "èƒŒæ™¯è‰²",

"prefCaptionsSize": "ãƒ•ã‚©ãƒ³ãƒˆã‚µã‚¤ã‚º",

"prefCaptionsOpacity": "ä¸é€æ˜Žåº¦",

"prefCaptionsStyle": "æ›¸å¼",
...
"captionsStylePopOn": "ãƒãƒƒãƒ—ãƒ»ã‚ªãƒ³",

"captionsStyleRollUp": "ãƒ­ãƒ¼ãƒ«ãƒ»ã‚¢ãƒƒãƒ—",

"prefCaptionsPosition": "ä½ç½®",

"captionsPositionOverlay": "ã‚ªãƒ¼ãƒãƒ¼ãƒ¬ã‚¤è¡¨ç¤º",

"captionsPositionBelow": "å‹•ç”»ã®ä¸‹éƒ¨",

"sampleCaptionText": "ã‚­ãƒ£ãƒ—ã‚·ãƒ§ãƒ³è¡¨ç¤ºã®ä¾‹",

"prefSuccess": "å¤‰æ›´ãŒä¿å­˜ã•ã‚Œã¾ã—ãŸã€‚",

"prefNoChange": "è¨­å®šãŒå¤‰æ›´ã•ã‚Œã¦ã„ã¾ã›ã‚“ã€‚",
...
"closeButtonLabel": "ãƒ€ã‚¤ã‚¢ãƒ­ã‚°ã‚’é–‰ã˜ã‚‹",

"windowButtonLabel": "ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã®è¨­å®š",

"windowMove": "ç§»å‹•",

"windowMoveAlert": "ãƒžã‚¦ã‚¹ã‚’ãƒ‰ãƒ©ãƒƒã‚°ã™ã‚‹ã‹çŸ¢å°ã‚­ãƒ¼ã§ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã‚’ç§»å‹•ã§ãã¾ã™; Enterã§çµ‚äº†",

"windowResize": "ã‚µã‚¤ã‚ºã‚’å¤‰ãˆã‚‹",

"windowResizeHeading": "ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã®ã‚µã‚¤ã‚ºå¤‰æ›´",

"windowResizeAlert": "ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã®ã‚µã‚¤ã‚ºãŒå¤‰æ›´ã•ã‚Œã¾ã—ãŸã€‚",

"width": "å¹…",

"height": "é«˜ã•",

"windowSendBack": "èƒŒé¢ã¸ç§»å‹•",

"windowSendBackAlert": "ã“ã®ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã¯ã“ã®ãƒšãƒ¼ã‚¸ã®ä»–ã®ã‚ªãƒ–ã‚¸ã‚§ã‚¯ãƒˆã‚ˆã‚ŠèƒŒé¢ã«ãªã‚Šã¾ã—ãŸã€‚",

"windowBringTop": "å‰é¢ã¸ç§»å‹•",

"windowBringTopAlert": "ã“ã®ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã¯ã“ã®ãƒšãƒ¼ã‚¸ã®ä»–ã®ã‚ªãƒ–ã‚¸ã‚§ã‚¯ãƒˆã‚ˆã‚Šå‰é¢ã«ãªã‚Šã¾ã—ãŸã€‚"
